...
const BoxTwo = () => {
  ...
  if(isMobile) {
    return (
      ...
      <div class="h-[100%] w-full flex flex-col absolute inset-0 items-center">
        ...
        <img src="src\public\static\images\ski.jpg" class="h-[50%] mx-auto flex rounded-full mt-5"></img>
        <br />
  ...
  return (
    ...
    <div className="bg-black text-white w-[100%] h-[100%] flex">
        ...
        <br />
        <img src="src\public\static\images\ski.jpg" class="h-[40%] mx-auto flex rounded-full"></img>
        <br />
